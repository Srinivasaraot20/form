...
def generate_student_details_excel(app):
    ...
    fields = [
        ...
        "Gender", "Religion", "Marital Status", "Community", "Category", "Nationality",
        ...
        "Qualification", "Year of Study", "Program", "Batch Code", "Submission Date", 
    ...
    data = [
        ...
        app.year_of_study.name if app.year_of_study else "", 
