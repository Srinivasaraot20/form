...
class StudentApplicationAdmin(admin.ModelAdmin):
    ...
    list_filter = (
        ...
        'occupation', 'qualification', 'marital_status', 'applying_qualification', 
    ...
    fieldsets = (
        ...
        ('Personal Details', {
            'fields': (
                ...
                'religion', 'community', 'category', 'nationality',
    ...
    actions = ['mark_approved', 'mark_rejected', 'need_correction', 'export_excel_action', 'export_csv_action', 'export_pdf', 'export_zip', 'download_documents']
